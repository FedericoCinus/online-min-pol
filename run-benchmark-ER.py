...
pol = 3 # polarization exponent in {1, 3}
pol_level = "" if pol == 1 else f"_pol{pol}"
...
for idx, (n, p, sigma, a, n_arms) in enumerate(combos, start=1):
    ...
    save_to = f"./figures/opdmin_vs_oful_ER_n{n}_p{int(100*p)}_sigma{int(100*sigma)}_arms{n_arms}_{n_e}{pol_level}.pdf"
